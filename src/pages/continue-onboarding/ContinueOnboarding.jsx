  ...
  return (
    <div className="w-full flex items-center justify-center font-sans">
      ...
      >
        ...
        <div className="lg:w-5/12 bg-[#042159] p-10 lg:p-16 flex flex-col justify-between text-white relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
            <div className="absolute top-[-10%] right-[-10%] w-64 h-64 bg-[#4DB8E4] rounded-full blur-3xl" />
          </div>

          <div className="relative z-10">
            <div className="w-14 h-14 bg-[#4DB8E4]/20 rounded-2xl flex items-center justify-center mb-8">
        ...
        <div className="lg:w-7/12 p-10 lg:p-16 flex flex-col justify-center">
          <div className="mb-10">
            <span className="inline-block px-4 py-1 rounded-full bg-blue-50 text-[#4DB8E4] text-[10px] font-black uppercase tracking-widest mb-4">
              Account Status: Partial Setup
            </span>
            <h1 className="text-3xl font-black text-[#042159] mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
            <div className="p-4 rounded-3xl bg-slate-50 border border-slate-100">
              <div className="flex items-center gap-2 mb-2 text-[#042159]">
                <FileText size={16} />
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full bg-[#042159] hover:bg-[#062d7a] text-white py-5 rounded-[24px] font-black uppercase tracking-[0.2em] text-xs flex items-center justify-center gap-3 transition-all shadow-xl shadow-blue-900/20 active:scale-[0.98]"
            >
            ...
            <p className="text-[10px] text-slate-400 text-center px-10 leading-relaxed">
              ...
              <button className="text-[#4DB8E4] hover:underline mx-1">
                Terms of Service
              </button>
              and acknowledge our
              <button className="text-[#4DB8E4] hover:underline mx-1">
          ...
          <div className="mt-12 pt-8 border-t border-slate-100 flex justify-between items-center">
            <button
              onClick={() => navigate(-1)}
              className="text-slate-400 text-[10px] font-black uppercase tracking-widest hover:text-[#042159]"
            >
              Logout Session
            </button>
            <button className="flex items-center gap-1 text-[#4DB8E4] text-[10px] font-black uppercase tracking-widest hover:underline">
