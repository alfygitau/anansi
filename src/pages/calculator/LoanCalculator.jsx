    ...
    <>
      <div className="min-h-screen bg-slate-50 text-primary pb-20">
        ...
        <div className="max-w-6xl sm:px-4 mx-auto">
          ...
          <div className="mt-6 mb-5 p-5 bg-slate-50 rounded-[32px] border border-slate-200 relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-sm font-black uppercase tracking-[0.15em] text-primary">
                  Financial Disclosure & Terms
                </h3>
              </div>

              {/* Left Column: The Core Disclaimer */}
              <div>
                <p className="text-sm text-slate-600 font-bold leading-relaxed">
                  The figures generated by this calculator are{" "}
                  <span className="text-primary italic underline decoration-secondary/50">
                    estimates for illustrative purposes only
                  </span>{" "}
                  and do not constitute a formal loan offer or a binding
                  contract.
                </p>
                <p className="text-xs text-slate-500 leading-relaxed">
                  While we strive for accuracy, the actual repayment amounts may
                  vary based on your final credit assessment, membership status,
                  and the specific terms of the loan product selected.
                </p>
              </div>
              ...
              <div className="bg-white/60 bg-slate-900/40 p-4 mt-3 rounded-2xl border border-slate-100 space-y-3">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <Percent className="text-secondary mt-0.5" size={14} />
                    <p className="text-xs text-slate-600">
                      <span className="font-bold text-primary">
                        Processing Fees:
                      </span>{" "}
                      Administrative costs associated with loan appraisal and
                      disbursement.
                    </p>
                  </li>
                  <li className="flex items-start gap-3">
                    <Info className="text-secondary mt-0.5" size={14} />
                    <p className="text-xs text-slate-600">
                      <span className="font-bold text-primary">
                        Insurance Premiums:
                      </span>{" "}
                      Mandatory credit life insurance to protect your family and
                      the Sacco in case of unforeseen events.
                    </p>
                  </li>
                  <li className="flex items-start gap-3">
                    <FileText className="text-secondary mt-0.5" size={14} />
                    <p className="text-xs text-slate-600">
                      <span className="font-bold text-primary">
                        Statutory Levies:
                      </span>{" "}
                      Any applicable government taxes, excise duty, or legal
                      fees (where collateral is involved).
                    </p>
                  </li>
                </ul>
              </div>
              ...
              <div className="mt-4 pt-3 border-t border-slate-200">
                <p className="text-[11px] text-slate-400 italic text-center leading-relaxed">
                  Final loan approval is subject to the Anansi Sacco Credit
                  Policy and the verification of all submitted documentation.
                  Please refer to our
                  <span className="text-primary font-bold cursor-pointer hover:text-secondary ml-1 transition-colors">
                    General Terms and Conditions
                  </span>{" "}
                  for a complete breakdown of our lending criteria.
                </p>
              </div>
            </div>
          </div>
