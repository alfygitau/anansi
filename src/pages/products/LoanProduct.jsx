...
import LoanProductLoder from "../../skeletons/LoanProductLoader";
                ...
                <div className="flex items-start gap-3 p-3 hover:bg-slate-50 rounded-xl transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-0.5">
                      ...
                      {Number(
                        loanProduct?.max_loan_to_shares_ratio || 0,
                      ).toFixed(0)}{" "}
              ...
              <div className="space-y-4 pt-2">
                <div className="flex justify-between items-center py-2 border-b border-slate-100">
                  <span className="text-xs text-slate-500 flex items-center gap-1.5">
                    ...
                    <HelpCircle
                      size={12}
                      className="opacity-60 text-slate-400"
                    />
                  </span>
                  <span className="text-sm font-bold text-slate-900">
                    {fomatAmount(
                      Number(loanProduct?.processing_fee_value) ?? 0,
                    )}
                  </span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-slate-100">
            ...
            <div className="bg-white text-slate-900 rounded-[32px] p-8 space-y-5 border border-slate-200/60 shadow-sm">
              ...
              <div className="space-y-3 pt-2 text-xs text-slate-600">
                ...
                <div className="flex gap-3 items-start">
                  ...
                  />
                  <p>
                    <strong>No Rollovers Allowed:</strong> This long-term
                    facility does not allow maturity dynamic balance roll-overs.
                  </p>
                </div>
