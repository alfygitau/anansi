    ...
    <>
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 md:gap-6">
            ...
            <button
              ...
              className="md:hidden p-2 text-[#042159] bg-slate-50 rounded-xl"
            >
              <Menu size={24} />
            </button>
          </div>
        ...
        {isMobileMenuOpen && (
          <>
            <motion.div
              ...
              className="fixed inset-0 bg-[#042159]/40 backdrop-blur-sm z-[100] md:hidden"
            />
            <motion.div
              initial={{ x: "100%" }}
              animate={{ x: 0 }}
            ...
            >
              ...
              <div className="mt-auto p-4 bg-blue-50 rounded-3xl">
                ...
                <button className="mt-3 text-xs font-bold text-[#4DB8E4]">
                  Contact Support
                </button>
              </div>
            </motion.div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-lg border-t border-slate-100 px-6 py-3 flex justify-between items-center md:hidden z-[40] pb-8">
        ...
        <div className="relative -top-6">
          <button
            onClick={() => navigate("/loan-products")}
            className="w-14 h-14 bg-[#042159] rounded-2xl shadow-xl shadow-blue-900/40 flex items-center justify-center text-white active:scale-90 transition-transform"
          >
            <PlusCircle size={28} />
          </button>
        </div>
...
const TabItem = ({ icon, active, onClick }) => (
  <button
    onClick={onClick}
    className={`p-2 transition-all ${active ? "text-[#042159] scale-110" : "text-slate-300"}`}
  >
